...
# Instead of passing a command parameter, I actually want to call it with a specific argument to each button, 
# thats why I use lambda without any arguments! 
...
#For the other Buttons, I have made different methods, so no need for lambda, just call the method.
